...
struct SuperfanDetailView: View {
            ...
            HStack(alignment: .top, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 3) {
                    ...
                    if let d = item.detail {
                        Text(d).dsFont(13).foregroundStyle(Color.dsFgSecondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                }
    ...
    private func playerStamp(_ p: LearnedPlayer) -> some View {
        ...
        return VStack(spacing: 5) {
            ...
            Text(lastName(p.name)).dsFont(12).foregroundStyle(Color.dsFgSecondary)
    ...
    private func tierRow(_ tier: SuperfanTier, _ range: String, _ blurb: String) -> some View {
        HStack(spacing: 8) {
            ...
            Text(blurb).dsFont(12).foregroundStyle(Color.dsFgSecondary)
                .fixedSize(horizontal: false, vertical: true)
            Spacer(minLength: 0)
        }
    }
    ...
    private func achievementCard(_ earned: EarnedAchievement) -> some View {
        ...
        return HStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 1) {
                ...
                Text(earned.description).dsFont(12).foregroundStyle(Color.dsFgSecondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
            Spacer(minLength: 0)
        }
